module.exports = {
  ...
  'avatar-pinned.js': require('./avatar-pinned.js'),
  ...
  'ting-insert-list.js': require('./ting-insert-list.js'),
  'ting-insert-new.js': require('./ting-insert-new.js'),
  'ting-user-list.js': require('./ting-user-list.js'),
