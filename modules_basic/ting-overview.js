...
//    })
      ...
      var div = h('div.column.scroller',
        ...
        h('div.scroller__wrapper__overview',
          ...
          h("div.skill_object.float.clear", {style: {'background':'lightgreen','border-color':'green'}}, h('a', {href: '#/new skill'}, 'new skill')),
          h("div.skill_object.float",{style: {'background':'lightgreen','border-color':'green'}}, h('a', {href: '#/new inquiry'}, 'new inquiry')),
          h('div.introduction'),
